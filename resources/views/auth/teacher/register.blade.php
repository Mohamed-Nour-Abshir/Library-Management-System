        ...
        <div class="row">
            <form class="form-vertical" action="{{ URL::route('student-registration-post') }}" method="POST">
                <div class="module-head">
                    <h3 class="text-dark">Teacher Registration Form</h3>
                </div>
                <div class="module-body">
                    ...
                    <div class="control-group">
                        <div class="controls row-fluid">
                            <input class="span4 form-control mb-2" type="number" placeholder="Teacher ID" name="rollnumber" value="{{ Request::old('rollnumber') }}" /> 								
