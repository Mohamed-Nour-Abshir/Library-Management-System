...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <form class="form-vertical" action="{{ URL::route('teacher.login.post') }}" method="POST">
                @csrf
                ...
                <div class="module-foot">
                    <div class="control-group">
                        ...
                        <p style="font-size: 15px; color:black;">New Teacher <a href="{{route('teacher.register')}}">Register here?</a></p>
                    </div>
                </div>
            </form>
        </div>
